...
public class AuctionAgent7 implements AuctionBehavior {
	...
	public List<Plan> plan(List<Vehicle> vcls, TaskSet tasksSet) {
		print("");
		print("====================== AUCTION AGENT 7 FINAL PLAN ======================================================================");
		// init
		this.vehiclesList = MyVehicle.transform(agent.vehicles());
		List<Plan> plans;
		...
		print("++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
		print("AUCTION AGENT 7 : number of tasks = " + tasksSet.size());
		...
		print("");
		print("FINAL BIDS AUCTION AGENT 7: ");
	...
	public Long askPrice(Task task) {
		...
		print("----- AUCTION AGENT 7 ASK PRICE: T"+ proposed+ "=" + task +" id = "+agent.id()+" -----");
		...
		print("----- AUCTION AGENT 7 : BIDDING TASK " + task.id + ", Bid = " + Math.round(b) + ", in " + duration + " sec");
		print("");
	...
	private double computeBiding() {
		...
		print("MC1=" + MC1 + ", MC2=" + MC2 + ", M1=" + M1.get(proposed) + ", M2=" + M2.get(proposed) + ", bid=" + bid + ", bidSupp=" + bidSupp + ", bidFactor=" + bidFactor);
		print("ratioLowerBound=" + ratioLowerBound.get(proposed) + ", ratioUpperBound=" + ratioUpperBound.get(proposed));
		
		bid = bid + bidSupp;
				
		return Math.max(bid, bidMin);
	}
	...
	public void printInfoAgent() {
		print("------------------------------------------------------------------------------");
		print("AUCTION AGENT 7 " + agent.id() + " INFORMATIONS :");
