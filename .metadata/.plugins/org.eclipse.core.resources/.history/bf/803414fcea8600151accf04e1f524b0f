...
//		System.out.println("Agent " + agent.id() + " has tasks " + tasks);
    ...
    private Node SLS() {
    	...
    	while(i < numIt) { // TODO
    		...
    		A = localChoice(N, Aold); // only keep bestNode in chooseNeighbours : more efficient? = rename "chooseBestNeigbours"
    ...
    private Node localChoice(ArrayList<Node> N, Node Aold) {
    	Node bestNode = null;
